...
const translations = {
  zh: {
    ...
    title1: '机器人实践者',
    title2: '与探索者',
    subtitle: '兼具机械、电控与算法全栈基础，正在拓展深度学习等领域。将创意转化为现实，用代码赋予机器生命。',
    github: 'GitHub',
    email: 'Email',
    resume: 'Resume',
    welcome: '欢迎交流',
  ...
  en: {
    ...
    title2: 'and Explorer',
    subtitle: 'A robotics practitioner with a foundation in mechanics, electronics, and algorithms, now expanding into deep learning. ' +
